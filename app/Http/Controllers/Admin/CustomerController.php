...
class CustomerController extends Controller
{
    ...
    public function update(Request $request, Customer $customer)
    {
       ...
       // DB::table('customers')->where('id', $customer->id)->update($validatedData);
        $customer->update($validatedData);

        return redirect()->route('customers.show')->with('editCustomer', "Customer has been updated successfuly");
    }
