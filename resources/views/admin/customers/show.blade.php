    ...
    <div class="card" style="width: 38rem;">
        <div class="card-body">
            ...
            <ul class="list-group list-group-flush">Details:
                ...
                <li class="list-group-item"><i class="fa fa-at"></i> {{ $customer->email }}</li>
                <li class="list-group-item"><i class="fa fa-map-marked-alt"></i> {{ $customer->address }}</li>
            </ul>
            <hr>
            ...
            <a href="#" class="btn btn-danger" title="Delete user {{ $customer->firstname.' '.$customer->lastname  }}"
                ...
                ><i class="fa fa-user-alt-slash"></i></a>
            <form action="{{ route('customers.destroy', ['customer' => $customer->id]) }}" method="post" id="delete-customer-form">
                @csrf 
                @method('DELETE')
            </form>
        </div>
